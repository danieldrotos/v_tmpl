...
set_property -dict {PACKAGE_PIN G19 IOSTANDARD LVCMOS33} [get_ports {LED[2]}]
set_property -dict {PACKAGE_PIN D14 IOSTANDARD LVCMOS33} [get_ports {LED[3]}]
...
set_property -dict {PACKAGE_PIN D19 IOSTANDARD LVCMOS33} [get_ports {LED[6]}]
set_property -dict {PACKAGE_PIN C19 IOSTANDARD LVCMOS33} [get_ports {LED[7]}]
# On-board blue LEDs 
